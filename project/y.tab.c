...
{
       0,    84,    84,    85,    86,    89,    96,   105,   114,   125,
     132,   141,   151,   152,   153,   154,   156,   157,   158,   159,
...
static const char *const yytname[] =
{
  ...
  "PROGRAM", "FUNCTION", "RETURN", "END_FUNCTION", "VARS", "ASSIGN",
  "newline", "print", "left_parenthesis", "right_parenthesis",
  "left_sbracket", "right_sbracket", "COMMA", "SEMICOLON",
  "character_value", "integer_value", "string_value", "INTEGER", "CHAR",
  "STRING", "DATA_TYPE", "identifier", "array_identifier", "STRUCT", "'>'",
  "$accept", "start", "function_declaration", "parameter_list", "body", YY_NULLPTR
};
#endif
...
{
       2,   -27,   -22,    19,   -28,     0,   -28,    -6,    17,    13,
      15,    12,    16,    -1,    28,    14,    -5,     1,    -1,   -28,
     -28,   -28,     4,    20,     3,     5,     7,   -28,     9,     4,
     -17,   -15,   -19,   -13,   -28,   -28,   -28,   -28,    10,    26,
     -28,    29,    30,    23,     8,    32,    24,    33,    34,   -28,
     -28,   -28,   -28,    35,    27,   -28,    11,   -28,   -28,   -28,
      37,    38,    39,   -28,   -28,   -28
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       7,     8,     0,     0,     0,     0,     0,     5,     0,     0,
       0,     0,     0,     0,     9,    10,     6,    12,     0,     0,
      13,     0,     0,     0,    14,     0,    15,     0,     0,    20,
      22,    23,    21,     0,     0,    18,     0,    19,    17,    16,
       0,     0,     0,    25,    26,    24
};
...
{
      15,    43,    44,     1,    37,     4,    40,     5,    46,     7,
       2,    45,    38,    39,    41,    42,    47,    48,    22,     6,
      29,    23,     9,    23,    20,    21,    10,    16,    13,    25,
      26,    49,     0,    54,    30,    31,    32,    33,    34,    35,
      61,    62,    11,    12,    18,    14,    19,    50,    28,    56,
      51,    52,    53,    55,    57,    58,    59,    60,    63,    64,
      65,    24,     0,     0,     0,    36
};

static const yytype_int8 yycheck[] =
{
       1,    20,    21,     1,    21,    32,    21,    29,    21,     9,
       8,    30,    29,    30,    29,    30,    29,    30,    17,     0,
      17,    20,    28,    20,    29,    30,     9,    28,    16,    25,
      26,    21,    -1,    25,    29,    30,    29,    30,    29,    30,
      29,    30,    29,    28,    16,    29,    32,    21,    28,    25,
...
{
       0,     1,     8,    34,    32,    29,     0,     9,    35,    28,
       9,    29,    28,    16,    29,     1,    28,    36,    16,    32,
      29,    30,    17,    20,    36,    25,    26,    37,    28,    17,
      29,    30,    29,    30,    29,    30,    37,    21,    29,    30,
      21,    29,    30,    20,    21,    30,    21,    29,    30,    21,
      21,    21,    21,    29,    25,    21,    25,    21,    21,    21,
      30,    29,    30,    21,    21,    21
};
...
#line 90 "project.y" /* yacc.c:1646  */
    { if(!isDuplicate((yyvsp[-4].strVal),retrieveDataType())){
                                            storeIdentifier((yyvsp[-4].strVal),retrieveDataType());
                                            storeDataType((yyvsp[-5].dataType));
                                          }else{
...
#line 227 "project.y" /* yacc.c:1906  */
